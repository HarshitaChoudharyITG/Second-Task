    ...
    setTimeout(function() {
      fetch(location.href)
        ...
        .then(data => {
          ...
          let productdata = doc.querySelector('.product-form__buttons');
          if (!productdata) {
            console.log("Product form not found in fetched data!");
            return;
          }
          let productForm = document.querySelector('.product-form__buttons');
          if (!productForm) {
            console.log("Product form not found on the current page!");
            return;
          } else {
            productForm.innerHTML = productdata.innerHTML;
          }      
          console.log("New input field with fetched data appended to the form.");
        })
        .catch(error => {
